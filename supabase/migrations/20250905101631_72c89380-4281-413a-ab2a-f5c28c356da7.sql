...
SELECT 
  b.id,
  CASE 
    WHEN b.category = 'accommodation' THEN 'Deluxe Ocean View Room'
    ELSE 'Full Day Island Hopping'
  END,
  CASE 
    WHEN b.category = 'accommodation' THEN 'Spacious room with stunning ocean views and private balcony'
    ELSE 'Visit 3 beautiful islands with snorkeling and lunch included'
  END,
  b.category,
  CASE 
    WHEN b.category = 'accommodation' THEN 350.00
    ELSE 95.00
  END,
  'SCR',
  'active',
